public class SimpleQueue
{
    public static void Run()
    {
        ...
        Console.WriteLine(value);
        // Defect(s) Found: 
        // 1-   Dequeue function Index was set to position 1 instead of 0
        // 2-   Enqueue function Index was set to position 0 instead of the last position
    ...
    {
        var lastItem = _queue.Count;
        _queue.Insert(lastItem, value);
    }
