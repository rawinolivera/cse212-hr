...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueue method was adding the person to the front of the queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The GetNextPerson did not include the condition for a person with Turns = 0
